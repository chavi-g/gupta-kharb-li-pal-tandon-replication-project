...
Steps:
 ...
 5. We wrote down our results in a preliminary CSV called 'prob.csv'. Then we read the CSV with our R chunk, performing data type conversion and manipulation same as the original paper. 
 6. We used qqplot to approximate the visualization in R. 
 7. We also displayed all the words relating to a particular topic in R. 
